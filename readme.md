...
<body>
    <div style="text-align: center;">
        <h2>This is my database of crypto wallets to all scammers and ruggers that I encounter.</h2>
    </div>
    <div style="text-align: center;">
    ...
    <h4>Sam Bankman Fried - SBF</h4>
    <ul>
        <li>Alameda Research 25: <code>0x84D34f4f83a87596Cd3FB6887cFf8F17Bf5A7B83</code>
            <ul><br>
