...
# ****************************************************************************************
''''''************************************************************************************
#       Description: This script will combine several files into one.
# *************************************************************************************'''
...
def merge_files():
    ...
    for i, path in enumerate(file_path):
        ...
        if content:
            combined_data.append(content.splitlines())
    
    # Create DataFrame
    df = pd.DataFrame(combined_data)
    
    # Save DataFrame to CSV for better readability
    df.to_csv(combined_file_path, index=False, header=False)
